...
export default function FoodOverlay({foodDetails, onClick}: FoodOverlayProps){
  ...
  console.log(foodDetails)
    return(
      <div className='absolute top-0 right-0 bg-colorText bg-opacity-30 w-screen h-screen flex items-center m-auto justify-center z-50'>
        <div className='relative w-[90%] px-4 bg-white rounded-lg shadow-customHeader lg:w-[553px]'>
          <button onClick={handleCloseOverlay} className='absolute bg-white top-[-20px] right-[-20px] p-3 rounded-full shadow-custom'>
